...
class AtcepRoamingDeviceUpdateResponse(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """AtcepRoamingDeviceUpdateResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this AtcepRoamingDeviceUpdateResponse.  # noqa: E501

        The list of Roaming Device objects.  # noqa: E501

        :return: The results of this AtcepRoamingDeviceUpdateResponse.  # noqa: E501
    ...
    def results(self, results):
        """Sets the results of this AtcepRoamingDeviceUpdateResponse.

        The list of Roaming Device objects.  # noqa: E501

        :param results: The results of this AtcepRoamingDeviceUpdateResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtcepRoamingDeviceUpdateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtcepRoamingDeviceUpdateResponse):
            return False
