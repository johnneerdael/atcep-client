...
class AtcepRoamingDeviceGroupsMultiResponse(object):
    ...
    """
    swagger_types = {
        'results': 'list[AtcepRoamingDeviceGroup]'
    }
    ...
    def __init__(self, results=None):  # noqa: E501
        """AtcepRoamingDeviceGroupsMultiResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this AtcepRoamingDeviceGroupsMultiResponse.  # noqa: E501

        The list of Roaming Device Group objects.  # noqa: E501

        :return: The results of this AtcepRoamingDeviceGroupsMultiResponse.  # noqa: E501
        :rtype: list[AtcepRoamingDeviceGroup]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this AtcepRoamingDeviceGroupsMultiResponse.

        The list of Roaming Device Group objects.  # noqa: E501

        :param results: The results of this AtcepRoamingDeviceGroupsMultiResponse.  # noqa: E501
        :type: list[AtcepRoamingDeviceGroup]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtcepRoamingDeviceGroupsMultiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtcepRoamingDeviceGroupsMultiResponse):
            return False
