...
class AtcepRoamingDeviceGroupDeleteRequest(object):
    ...
    def __init__(self, ids=None):  # noqa: E501
        """AtcepRoamingDeviceGroupDeleteRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def ids(self):
        """Gets the ids of this AtcepRoamingDeviceGroupDeleteRequest.  # noqa: E501

        The list of Roaming Device Group object identifiers.  # noqa: E501

        :return: The ids of this AtcepRoamingDeviceGroupDeleteRequest.  # noqa: E501
        :rtype: list[int]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this AtcepRoamingDeviceGroupDeleteRequest.

        The list of Roaming Device Group object identifiers.  # noqa: E501

        :param ids: The ids of this AtcepRoamingDeviceGroupDeleteRequest.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtcepRoamingDeviceGroupDeleteRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtcepRoamingDeviceGroupDeleteRequest):
            return False
