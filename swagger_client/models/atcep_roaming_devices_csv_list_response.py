...
class AtcepRoamingDevicesCSVListResponse(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """AtcepRoamingDevicesCSVListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this AtcepRoamingDevicesCSVListResponse.  # noqa: E501

        Roaming devices for csv file  # noqa: E501

        :return: The results of this AtcepRoamingDevicesCSVListResponse.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def results(self, results):
        """Sets the results of this AtcepRoamingDevicesCSVListResponse.

        Roaming devices for csv file  # noqa: E501

        :param results: The results of this AtcepRoamingDevicesCSVListResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtcepRoamingDevicesCSVListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtcepRoamingDevicesCSVListResponse):
            return False
