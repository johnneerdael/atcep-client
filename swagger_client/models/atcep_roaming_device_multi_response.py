...
class AtcepRoamingDeviceMultiResponse(object):
    ...
    """
    swagger_types = {
        'results': 'list[AtcepRoamingDevice]',
    ...
    def __init__(self, results=None, total_result_count=None):  # noqa: E501
        """AtcepRoamingDeviceMultiResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this AtcepRoamingDeviceMultiResponse.  # noqa: E501

        The list of Roaming Device objects.  # noqa: E501

        :return: The results of this AtcepRoamingDeviceMultiResponse.  # noqa: E501
        :rtype: list[AtcepRoamingDevice]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this AtcepRoamingDeviceMultiResponse.

        The list of Roaming Device objects.  # noqa: E501

        :param results: The results of this AtcepRoamingDeviceMultiResponse.  # noqa: E501
        :type: list[AtcepRoamingDevice]
        """
    ...
    def total_result_count(self):
        """Gets the total_result_count of this AtcepRoamingDeviceMultiResponse.  # noqa: E501

        Total number of results  # noqa: E501

        :return: The total_result_count of this AtcepRoamingDeviceMultiResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def total_result_count(self, total_result_count):
        """Sets the total_result_count of this AtcepRoamingDeviceMultiResponse.

        Total number of results  # noqa: E501

        :param total_result_count: The total_result_count of this AtcepRoamingDeviceMultiResponse.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtcepRoamingDeviceMultiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtcepRoamingDeviceMultiResponse):
            return False
